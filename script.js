...
const speakers = [
  {
    ...
    info: 'Rehgan Avon is the Product Manager at Open Data Group. She has taught Introduction to Data Science courses to MBA students across the US.',
    image: 'images/speakers/Rehgan_Avon.jpeg',
  },
  {
    id: 1,
    name: 'Feryal Ozel',
    position: 'Professor, University of Arizona',
  ...
  },
  {
    ...
    position: 'Chief of Staff, Dealerweb',
    info: 'Janette manages and develops key strategic initiatives, including the transformation of the technology department to drive efficiency and reduce time to market through the use of automation and agile development.',
  ...
  },
  {
    ...
    info: 'Carol serves on Project Jupyter’s Steering Council and works as a Core Developer on JupyterHub and mybinder.org. She serves as a co-editor of The Journal of Open Source Education (JOSE).',
  ...
  },
  {
    ...
    info: 'Noelle is a multi-award-winning technologist who specializes in conversational AI and Voice Technology, Intelligent Apps and Agents, and Responsible AI Practices. She has lead teams at NPR, Microsoft, and Amazon.',
